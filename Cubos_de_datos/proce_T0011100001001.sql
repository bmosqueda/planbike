create procedure SP_T0011100001001()
BEGIN  
    
  DROP TABLE IF EXISTS T0011100001001;
  
  CREATE TABLE T0011100001001
  ...
  INSERT INTO Bitacora_Cubos(Tabla, Accion, Fecha_Hora)
    VALUES('T0011100001001','Recalculo', NOW());
